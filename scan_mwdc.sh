...
python mwdc_processor.py /home/h487/data/parquet/run${1}.parquet --output-file /home/h487/data/parquet/run${1}_mwdc.parquet #--output-wire-data #--output-for-samidare <=For Endo-san 
cd -
