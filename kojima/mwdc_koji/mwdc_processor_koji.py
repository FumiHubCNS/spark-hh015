...
plane_shifts = [0.07, 0.04, 0.08, 0.15, -0.06, 0.05] #diffx1x2, diffx3x4, diffy1y2, diffy3y4, diffx32, diffy32 for run1008
center_id1 = 7.25
center_id2 = 7.75
dc31_x3_shift = 0.05
dc31_y3_shift = -0.2
calib_runname="run1078"
...
def calib_mwdc_data(spark: SparkSession, df: DataFrame, for_samidare: bool) -> DataFrame:
    ...
    for plane in planes:
        ...
        # Monotone converter
        df_conv = spark.read.csv(f"/home/h487/notebooks/jan2026/kojima/mwdc_koji/prm/{plane}_drift_calib_data_{calib_runname}.csv",inferSchema=True,header=True)
...
if __name__ == "__main__":
    ...
    if args.output_file:
        ...
        ofname = stem + ("_mwdc_koji.parquet")
