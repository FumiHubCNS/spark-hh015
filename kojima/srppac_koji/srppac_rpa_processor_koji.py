...
def decode_srppac_amaneq(spark: SparkSession, df: DataFrame, preamp_type: str) -> DataFrame:
    ...
    df_prm_x = spark.read.csv(f'/home/h487/notebooks/jan2026/kojima/srppac_koji/prm/srx_charge_calib_{preamp_type}_{CALIB_RUNNAME}.csv', inferSchema = True, header = True)
    df_prm_y = spark.read.csv(f'/home/h487/notebooks/jan2026/kojima/srppac_koji/prm/sry_charge_calib_{preamp_type}_{CALIB_RUNNAME}.csv', inferSchema = True, header = True)
...
if __name__ == "__main__":
    ...
    df_srppac = df_srppac.withColumn("runname",F.lit(runname))
